...
from pos_app.models import (
    User, StatusModel,TableResto, Category, MenuResto, 
)
...
"""from api.serializers import (
   RegisterUserSerializer, UserSerializer,ProfileSerializer,RegisterUserSerializer, StatusModelSerializer, TableRestoSerializer,CategorySerializer, MenuRestoSerializer
)"""
from api.serializers import (
   RegisterUserSerializer,RegisterUserSerializer, TableRestoSerializer,
   LoginSerializer, MenuRestoSerializer
)
